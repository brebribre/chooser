    ...
    var colors: [Color] {
        ...
        case .midnight:
            return [
                ...
                Color(red: 0.22, green: 0.18, blue: 0.50),
                Color(red: 0.08, green: 0.08, blue: 0.22)
            ]
        case .ocean:
            return [
                Color(red: 0.08, green: 0.25, blue: 0.50),
                Color(red: 0.12, green: 0.40, blue: 0.65),
                Color(red: 0.05, green: 0.15, blue: 0.35)
            ]
        case .sunset:
            return [
                Color(red: 0.85, green: 0.35, blue: 0.20),
                Color(red: 0.75, green: 0.20, blue: 0.35),
                Color(red: 0.45, green: 0.10, blue: 0.25)
            ]
        case .aurora:
            return [
                Color(red: 0.10, green: 0.45, blue: 0.50),
                Color(red: 0.15, green: 0.55, blue: 0.45),
                Color(red: 0.20, green: 0.15, blue: 0.50)
            ]
        case .ember:
            return [
                Color(red: 0.70, green: 0.20, blue: 0.10),
                Color(red: 0.55, green: 0.30, blue: 0.08),
                Color(red: 0.35, green: 0.10, blue: 0.08)
            ]
        case .forest:
            return [
                Color(red: 0.08, green: 0.40, blue: 0.20),
        ...
        case .lavender:
            return [
                ...
                Color(red: 0.50, green: 0.28, blue: 0.70),
